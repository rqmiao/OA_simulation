...
!
   ...
   NOX = NHIGHNOX
   ALPHA(NOX,1,PARENTISOP) = 0.000e+0_fp
   ALPHA(NOX,2,PARENTISOP) = 0.000e+0_fp
   ALPHA(NOX,3,PARENTISOP) = 0.000e+0_fp
   ALPHA(NOX,4,PARENTISOP) = 0.017e+0_fp
   ...
   NOX = NHIGHNOX
   ALPHA(NOX,1,PARENTBENZ) = 0.024e+0_fp
   ALPHA(NOX,2,PARENTBENZ) = 0.000e+0_fp
   ALPHA(NOX,3,PARENTBENZ) = 0.835e+0_fp
   ALPHA(NOX,4,PARENTBENZ) = 0.048e+0_fp
   ! LOW NOX BENZ (non-volatile)
   !ALPHA(2,4,PARENTBENZ) = 0.37e+0_fp
   NOX = NLOWNOX
   ALPHA(NOX,1,PARENTBENZ) = 0.000e+0_fp
   ALPHA(NOX,2,PARENTBENZ) = 0.000e+0_fp
   ALPHA(NOX,3,PARENTBENZ) = 0.485e+0_fp
   ALPHA(NOX,4,PARENTBENZ) = 0.000e+0_fp
   ...
   NOX = NHIGHNOX
   ALPHA(NOX,1,PARENTTOLU) = 0.000e+0_fp
   ALPHA(NOX,2,PARENTTOLU) = 0.105e+0_fp
   ALPHA(NOX,3,PARENTTOLU) = 0.084e+0_fp
   ALPHA(NOX,4,PARENTTOLU) = 0.023e+0_fp
   ! LOW NOX TOLU
   !ALPHA(2,4,PARENTTOLU) = 0.30e+0_fp
   NOX = NLOWNOX
   ALPHA(NOX,1,PARENTTOLU) = 0.000e+0_fp
   ALPHA(NOX,2,PARENTTOLU) = 0.000e+0_fp
   ALPHA(NOX,3,PARENTTOLU) = 0.959e+0_fp
   ALPHA(NOX,4,PARENTTOLU) = 0.000e+0_fp
   ...
   NOX = NHIGHNOX
   ALPHA(NOX,1,PARENTXYLE) = 0.000e+0_fp
   ALPHA(NOX,2,PARENTXYLE) = 0.049e+0_fp
   ALPHA(NOX,3,PARENTXYLE) = 0.076e+0_fp
   ALPHA(NOX,4,PARENTXYLE) = 0.016e+0_fp
   ! LOW NOX XYLE
   !ALPHA(2,4,PARENTXYLE) = 0.36e+0_fp
   NOX = NLOWNOX
   ALPHA(NOX,1,PARENTXYLE) = 0.000e+0_fp
   ALPHA(NOX,2,PARENTXYLE) = 0.000e+0_fp
   ALPHA(NOX,3,PARENTXYLE) = 0.549e+0_fp
   ALPHA(NOX,4,PARENTXYLE) = 0.006e+0_fp
   ...
   ALPHA(1,1,PARENTNAP) = 0.052e+0_fp
   ALPHA(1,2,PARENTNAP) = 0.201e+0_fp
   ALPHA(1,3,PARENTNAP) = 0.296e+0_fp
   ALPHA(1,4,PARENTNAP) = 0.011e+0_fp
   ! LOW NOX
   ! Ox = HO2
   !ALPHA(2,4,PARENTNAP) = 0.73e+0_fp
   ALPHA(2,5,PARENTNAP) = 0.73e+0_fp  !(mrq, 02/20) from 4 to 5

   !(mrq, 05/20) add SOA yield of IVOC5 and IVOC4
   ALPHA(1,1,PARENTIVOC5) = 0.078e+0_fp
   ALPHA(1,2,PARENTIVOC5) = 0.439e+0_fp
   ALPHA(1,3,PARENTIVOC5) = 0.271e+0_fp
   ALPHA(1,4,PARENTIVOC5) = 0.049e+0_fp
   ! LOW NOX
   ! Ox = HO2
   ALPHA(2,5,PARENTIVOC5) = 0.73e+0_fp  !(mrq, 02/20) from 4 to 5

   ALPHA(1,1,PARENTIVOC4) = 0.089e+0_fp
   ALPHA(1,2,PARENTIVOC4) = 0.550e+0_fp
   ALPHA(1,3,PARENTIVOC4) = 0.200e+0_fp
   ALPHA(1,4,PARENTIVOC4) = 0.063e+0_fp
   ! LOW NOX
   ! Ox = HO2
   ALPHA(2,5,PARENTIVOC4) = 0.73e+0_fp  !(mrq, 02/20) from 4 to 5
...
!
   ...
   IF ( id_POA1 > 0 ) THEN
      ...
      DO NOX = 1, NNOX(JSV)   ! update dims (hotp 5/22/10)
         ...
         GM0(IPR,JSV) = GM0(IPR,JSV) + DELHC(IPR) !POAEMISS(I,J,L,IPR)
         !---------------------------------------------
         ...
         DELTASOGSAVE(I,J,L,1,JHC) = DELHC(IPR)
